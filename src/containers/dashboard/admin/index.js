            ...
            <div>
              <Link to={"/admin/products"}>
                <div
                  className={
                    "link " +
                    (this.props.location.pathname == "/admin/products"
                      ? "active"
                      : "")
                  }
                >
              ...
              <Link to={"/admin/new-product"}>
                <div
                  className={
                    "link " +
                    (this.props.location.pathname == "/admin/new-product"
                      ? "active"
                      : "")
                  }
                >
              ...
              <Link to={"/admin/custom"}>
                <div
                  className={
                    "link " +
                    (this.props.location.pathname == "/admin/custom"
                      ? "active"
                      : "")
                  }
                >
        ...
        <Col span={19}>
          ...
          <Switch>
            <div>
              ...
              />
              <Route
                path={`${this.props.match.path}/new-product`}
