        ...
        <div className="form justify-content-center">
          ...
          <Row align="middle">
            ...
            <Col span={18}>
              ...
              >
                <Button>
                  {this.state.fileBaby &&
                  this.state.fileBaby[0] &&
                  this.state.fileBaby[0].name
                    ? this.state.fileBaby[0].name
                    : "Escolher..."}
                </Button>
              </Upload>
          ...
          <Row align="middle">
            ...
            <Col span={18} className="d-flex">
              ...
              >
                <Button>
                  {this.state.fileMom &&
                  this.state.fileMom[0] &&
                  this.state.fileMom[0].name
                    ? this.state.fileMom[0].name
                    : "Escolher..."}
                </Button>
              </Upload>
          ...
          <Row align="middle">
            ...
            <Col span={18}>
              <Input
                onChange={(e) => {
                  this.setState({ mom_name: e.target.value });
                }}
                placeholder={""}
              />
            </Col>
          ...
          <Row align="middle">
            ...
            <Col span={18} className="d-flex">
              ...
              >
                <Button>
                  {this.state.fileDad &&
                  this.state.fileDad[0] &&
                  this.state.fileDad[0].name
                    ? this.state.fileDad[0].name
                    : "Escolher..."}
                </Button>
              </Upload>
          ...
          <Row align="middle">
            ...
            <Col span={18}>
              <Input
                onChange={(e) => {
                  this.setState({ dad_name: e.target.value });
                }}
                placeholder={""}
              />
            </Col>
          ...
          <Row align="middle">
            ...
            <Col span={18}>
              ...
              >
                <Button>
                  {this.state.fileBack &&
                  this.state.fileBack[0] &&
                  this.state.fileBack[0].name
                    ? this.state.fileBack[0].name
                    : "Escolher..."}
                </Button>
              </Upload>
