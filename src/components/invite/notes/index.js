...
export default class Notes extends Component {
    render() {
        return (
            <section id="messages" class={this.props.event.theme == "green" ? "invite-green" : "invite-purple"}>
                ...
                <OwlCarousel options={{ nav: true, center: true }} class="owl-carousel owl-carousel-testimonial">
                    {
                        this.props.event && this.props.event.notes ?
                            this.props.event.notes.map((note) => {
                                return <div key={note.id} class="message-box d-flex flex-row">
                                    <img class="testiminial-img" src={note.user.image_url} />
