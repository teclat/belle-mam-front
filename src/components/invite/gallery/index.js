  ...
  render() {
    return (
      ...
      >
          ...
          <img
            src={
              this.props.event.theme === "green"
                ? require("../../../assets/images/green-heart.png")
                : require("../../../assets/images/purple-heart.png")
            }
            alt=""
          />
        ...
        <OwlCarousel
          options={{ nav: true, center: true, loop: true, navText: ["<", ">"] }}
          class="owl-carousel owl-carousel-gallery"
        >
